...
<div class="settingsContainer column">
    <div class="formSection">
        <form method="POST">
            ...
            ?>
            <input type="text" name="firstName" placeholder="First name" value="<? echo $firstName ?>">
            <input type="text" name="lastName" placeholder="Last name" value="<? echo $lastName ?>">
            <input type="email" name="email" placeholder="Email" value="<? echo $email ?>">
